...
let store = document.getElementById('container');
store.style.backgroundColor = 'pink';
...
let method = document.getElementsByClassName('dom-methods');
...
var query = document.querySelectorAll('.dom-methods');
for(var i=0;i<query.length;i++){
  query[i].style.fontSize='20px';
}
...
let copy=document.getElementsByClassName('copyright');
copy.remove;